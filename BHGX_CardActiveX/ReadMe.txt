========================================================================
    活动模板库：BHGX_CardActiveX 项目概述
========================================================================

应用程序向导已为您创建了此 BHGX_CardActiveX 项目，您可以在此基础之上
编写自己的动态链接库 (DLL)。
...
BHGX_CardActiveX.idl
    ...
    和 coclass 的 IDL 定义。
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明                 (BHGX_CardActiveX.h)
        GUID 定义                                (BHGX_CardActiveX_i.c)
        一个类型库                               (BHGX_CardActiveX.tlb)
        封送代码                                 (BHGX_CardActiveX_p.c 和 dlldata.c)

BHGX_CardActiveX.h
    此文件包含在 BHGX_CardActiveX.idl 中定义的项的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 BHGX_CardActiveX.pch 的预编译头 (PCH) 文件
...
BHGX_CardActiveXps.vcproj
	...
	dlldata.c、BHGX_CardActiveX_i.c 和 BHGX_CardActiveX_p.c，它们。
