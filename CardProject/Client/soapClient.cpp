...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.17 2011-09-26 12:48:38 GMT")
...
{	struct ns__CardRegisger soap_tmp_ns__CardRegisger;
	...
	*strRetXML = NULL;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (strRetXML && soap_tmp_ns__CardRegisgerResponse->strRetXML)
...
{	struct ns__CardCheck soap_tmp_ns__CardCheck;
	...
	*strRetXML = NULL;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (strRetXML && soap_tmp_ns__CardCheckResponse->strRetXML)
...
{	struct ns__CardCheckForNH soap_tmp_ns__CardCheckForNH;
	...
	*strRetXML = NULL;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (strRetXML && soap_tmp_ns__CardCheckForNHResponse->strRetXML)
